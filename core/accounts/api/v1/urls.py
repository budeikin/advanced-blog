...
urlpatterns = [
    ...
    path(
        "activation/resend/", ActivationResendView.as_view(), name="resend-activation"
    ),
    # change password
    path("change-password/", ChangePasswordAPIView.as_view(), name="change-password"),
    # reset password
    path("forget-password/", ForgetPasswordAPIView.as_view(),name="forget-password"),
    path("password_reset/<str:token>", ResetPasswordView.as_view(),name="reset-password-confirm"),
