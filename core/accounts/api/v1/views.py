...
from .serializer import (
    ...
    AbtivationResendSerializer,
    ChangePasswordSerializer,
    ProfileSerializer,
    CustomAuthTokenSerializer,
    CustomTokenObtainPairSerializer,
    ForgetPasswordSerilizer,
...
class ActivationResendView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        EmailThread(email_obj).start()
        return Response(
            "user activation resend successfully", status=status.HTTP_201_CREATED
        )
...
class ResetPasswordView(APIView):
    ...
    def get(self, request,token, *args, **kwargs):
        try:
            ...
            return Response("token is not valid")
        return Response(f'You can reset your password now')
    ...
    def post(self, request, *args, **kwargs):
        ...
        user.save()
        return Response('password reseted succesfully')
